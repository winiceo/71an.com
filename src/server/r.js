...
var fs = require("fs")
const racerHighway = require('./vendor/racer-highway')
...
module.exports = (app, backend) => {
  ...
  app.all("/editor/scene/:d", function(req, res) {
    ...
    let config = {
      ...
      "url": {
        ...
        "realtime": {
          "http": "ws://192.168.1.103:4444/channel"
        },
        "messenger": {
  ...
  app.all('/api/projects/:d/assets', function(req, res, params) {
    ...
    connection.createFetchQuery('assets', {
      "project": {
        $eq: req.params.d
      }
  ...
  app.get("/test", function(req, res) {
    res.json({
      ...
      "scene": {
        "id": "b8beebd6-f0c7-4cbe-bc2e-ab186d5034d7"
      },
      "url": {
        "api": "http://192.168.1.103:4444/api",
        "home": "http://192.168.1.103:4444",
